					...
					if(backgammonGameService.isCanKeepPlay(gameRoomName, username)){
						...
						if((backgammonGameService.getIsWhite(gameRoomName, username) && backgammonGameService.isWhiteCanPlay(gameRoomName)) ||
							...
							if(from == BackgammonBoard.EATEN_WHITE){
								...
								turnNotPassedWhitePawnTakenOutEvent.setBoard(backgammonGameService.getBoard(gameRoomName));
								...
								turnNotPassedBlackPawnTakenOutEvent.setBoard(backgammonGameService.getBoard(gameRoomName));
								...
								turnNotPassedBlackAteWhitePawnEvent.setBoard(backgammonGameService.getBoard(gameRoomName));
								...
								turnNotPassedWhiteAteBlackPawnEvent.setBoard(backgammonGameService.getBoard(gameRoomName));
							...
							if(from == BackgammonBoard.EATEN_WHITE){
								...
								lastMoveWhitePawnTakenOutEvent.setBoard(backgammonGameService.getBoard(gameRoomName));
								...
								lastMoveBlackPawnTakenOutEvent.setBoard(backgammonGameService.getBoard(gameRoomName));
								...
								lastMoveBlackAteWhitePawnEvent.setBoard(backgammonGameService.getBoard(gameRoomName));
								...
								lastMoveWhiteAteBlackPawnEvent.setBoard(backgammonGameService.getBoard(gameRoomName));
