...
public class OpenByLeftFirstEventConsumer extends SimpleEventsConsumer {
	...
	public void consumerOperations(ConsumerRecord<String, String> record) {
		...
		try{
			logger.info("Will stop game..." + openByLeftFirstEvent);
			String gameRoomName = openByLeftFirstEvent.getGameRoom().getName();
			...
			gameStoppedEvent.setUuid(openByLeftFirstEvent.getUuid());
			gameStoppedEvent.setArrived(new Date());
			gameStoppedEvent.setClazz("GameStoppedEvent");
			gameStoppedEvent.setUserName(openByLeftFirstEvent.getOpenBy());
			gameStoppedEvent.setGameRoom(openByLeftFirstEvent.getGameRoom());
