...
@Component
@Scope("prototype")
public class LastMoveBlackPawnCameBackAndAteWhitePawnEvent extends BackgammonEvent{
	...
	public LastMoveBlackPawnCameBackAndAteWhitePawnEvent() {
	
	}

	public LastMoveBlackPawnCameBackAndAteWhitePawnEvent(String userName, String gameRoomName, int from, int to,
	...
	public String toString() {
		return "LastMoveBlackPawnCameBackAndAteWhitePawnEvent [userName=" + userName + ", gameRoomName=" + gameRoomName
