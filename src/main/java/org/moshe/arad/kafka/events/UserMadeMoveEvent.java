...
@Component
@Scope("prototype")
public class UserMadeMoveEvent extends BackgammonEvent{
	...
	public UserMadeMoveEvent() {
	
	}

	public UserMadeMoveEvent(String userName, String gameRoomName, int from, int to, BackgammonBoard board,
	...
	public String toString() {
		return "UserMadeMoveEvent [userName=" + userName + ", gameRoomName=" + gameRoomName + ", from=" + from + ", to="
				+ to + ", board=" + board + ", firstDice=" + firstDice + ", secondDice=" + secondDice + ", isWhite="
				+ isWhite + "]";
	}
