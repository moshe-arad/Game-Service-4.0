...
@Component
@Scope("prototype")
public class WhitePawnTakenOutEvent extends BackgammonEvent{
	...
	public WhitePawnTakenOutEvent() {
	
	}

	public WhitePawnTakenOutEvent(String userName, String gameRoomName, int from, int to, BackgammonBoard board,
	...
	public String toString() {
		return "WhitePawnTakenOutEvent [userName=" + userName + ", gameRoomName=" + gameRoomName + ", from=" + from
