...
@Component
@Scope("prototype")
public class WhitePawnCameBackAndAteBlackPawnEvent extends BackgammonEvent{
	...
	public WhitePawnCameBackAndAteBlackPawnEvent() {
	
	}

	public WhitePawnCameBackAndAteBlackPawnEvent(String userName, String gameRoomName, int from, int to,
	...
	public String toString() {
		return "WhitePawnCameBackAndAteBlackPawnEvent [userName=" + userName + ", gameRoomName=" + gameRoomName
