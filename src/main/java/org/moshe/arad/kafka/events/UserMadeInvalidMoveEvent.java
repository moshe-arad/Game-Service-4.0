...
@Component
@Scope("prototype")
public class UserMadeInvalidMoveEvent extends BackgammonEvent{
	...
	public UserMadeInvalidMoveEvent() {
	
	}

	public UserMadeInvalidMoveEvent(String userName, String gameRoomName, int from, int to, BackgammonBoard board,
