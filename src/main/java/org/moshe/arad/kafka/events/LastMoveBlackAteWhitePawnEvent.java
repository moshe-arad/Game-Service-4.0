...
@Component
@Scope("prototype")
public class LastMoveBlackAteWhitePawnEvent extends BackgammonEvent{
	...
	public LastMoveBlackAteWhitePawnEvent() {
	
	}

	public LastMoveBlackAteWhitePawnEvent(String userName, String gameRoomName, int from, int to, BackgammonBoard board,
	...
	public String toString() {
		return "LastMoveBlackAteWhitePawnEvent [userName=" + userName + ", gameRoomName=" + gameRoomName + ", from="
