...
@Component
@Scope("prototype")
public class LastMoveWhitePawnCameBackAndAteBlackPawnEvent extends BackgammonEvent{
	...
	public LastMoveWhitePawnCameBackAndAteBlackPawnEvent() {
	
	}

	public LastMoveWhitePawnCameBackAndAteBlackPawnEvent(String userName, String gameRoomName, int from, int to,
	...
	public String toString() {
		return "LastMoveWhitePawnCameBackAndAteBlackPawnEvent [userName=" + userName + ", gameRoomName=" + gameRoomName
