...
@Component
@Scope("prototype")
public class LastMoveBlackPawnCameBackEvent extends BackgammonEvent{
	...
	public LastMoveBlackPawnCameBackEvent() {
	
	}

	public LastMoveBlackPawnCameBackEvent(String userName, String gameRoomName, int from, int to, BackgammonBoard board,
	...
	public String toString() {
		return "LastMoveBlackPawnCameBackEvent [userName=" + userName + ", gameRoomName=" + gameRoomName + ", from="
