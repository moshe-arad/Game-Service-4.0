...
@Component
@Scope("prototype")
public class WhiteAteBlackPawnEvent extends BackgammonEvent{
	...
	public WhiteAteBlackPawnEvent() {
	
	}

	public WhiteAteBlackPawnEvent(String userName, String gameRoomName, int from, int to, BackgammonBoard board,
	...
	public String toString() {
		return "WhiteAteBlackPawnEvent [userName=" + userName + ", gameRoomName=" + gameRoomName + ", from=" + from
