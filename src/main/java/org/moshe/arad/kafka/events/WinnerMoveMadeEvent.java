...
@Component
@Scope("prototype")
public class WinnerMoveMadeEvent extends BackgammonEvent{
	...
	public WinnerMoveMadeEvent() {
	
	}

	public WinnerMoveMadeEvent(String userName, String gameRoomName, int from, int to,
	...
	public String toString() {
		return "UserMadeMoveEvent [userName=" + userName + ", gameRoomName=" + gameRoomName + ", from=" + from + ", to="
				+ to + ", backgammonBoardJson=" + backgammonBoardJson + ", firstDice=" + firstDice + ", secondDice="
