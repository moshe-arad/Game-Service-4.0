...
@Component
@Scope("prototype")
public class BlackPawnCameBackAndAteWhitePawnEvent extends BackgammonEvent{
	...
	public BlackPawnCameBackAndAteWhitePawnEvent() {
	
	}

	public BlackPawnCameBackAndAteWhitePawnEvent(String userName, String gameRoomName, int from, int to,
	...
	public String toString() {
		return "BlackPawnCameBackAndAteWhitePawnEvent [userName=" + userName + ", gameRoomName=" + gameRoomName
