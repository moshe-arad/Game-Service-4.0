...
@Component
@Scope("prototype")
public class TurnNotPassedBlackPawnTakenOutEvent extends BackgammonEvent{
	...
	public TurnNotPassedBlackPawnTakenOutEvent() {
	
	}

	public TurnNotPassedBlackPawnTakenOutEvent(String userName, String gameRoomName, int from, int to, BackgammonBoard board,
	...
	public String toString() {
		return "TurnNotPassedBlackPawnTakenOutEvent [userName=" + userName + ", gameRoomName=" + gameRoomName
