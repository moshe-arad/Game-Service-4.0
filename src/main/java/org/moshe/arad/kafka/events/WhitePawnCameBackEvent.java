...
@Component
@Scope("prototype")
public class WhitePawnCameBackEvent extends BackgammonEvent{
	...
	public WhitePawnCameBackEvent() {
	
	}

	public WhitePawnCameBackEvent(String userName, String gameRoomName, int from, int to, BackgammonBoard board,
