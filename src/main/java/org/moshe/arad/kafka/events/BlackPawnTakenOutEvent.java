...
@Component
@Scope("prototype")
public class BlackPawnTakenOutEvent extends BackgammonEvent{
	...
	public BlackPawnTakenOutEvent() {
	
	}

	public BlackPawnTakenOutEvent(String userName, String gameRoomName, int from, int to, BackgammonBoard board,
	...
	public String toString() {
		return "BlackPawnTakenOutEvent [userName=" + userName + ", gameRoomName=" + gameRoomName + ", from=" + from
