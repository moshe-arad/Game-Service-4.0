...
@Component
@Scope("prototype")
public class TurnNotPassedWhitePawnCameBackAndAteBlackPawnEvent extends BackgammonEvent{
	...
	public TurnNotPassedWhitePawnCameBackAndAteBlackPawnEvent() {
	
	}

	public TurnNotPassedWhitePawnCameBackAndAteBlackPawnEvent(String userName, String gameRoomName, int from, int to,
	...
	public String toString() {
		return "TurnNotPassedWhitePawnCameBackAndAteBlackPawnEvent [userName=" + userName + ", gameRoomName="
				+ gameRoomName + ", from=" + from + ", to=" + to + ", backgammonBoardJson=" + backgammonBoardJson
