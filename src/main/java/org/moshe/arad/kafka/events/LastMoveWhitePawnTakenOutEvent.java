...
@Component
@Scope("prototype")
public class LastMoveWhitePawnTakenOutEvent extends BackgammonEvent{
	...
	public LastMoveWhitePawnTakenOutEvent() {
	
	}

	public LastMoveWhitePawnTakenOutEvent(String userName, String gameRoomName, int from, int to, BackgammonBoard board,
