...
@Component
@Scope("prototype")
public class BlackAteWhitePawnEvent extends BackgammonEvent{
	...
	public BlackAteWhitePawnEvent() {
	
	}

	public BlackAteWhitePawnEvent(String userName, String gameRoomName, int from, int to, BackgammonBoard board,
	...
	public String toString() {
		return "BlackAteWhitePawnEvent [userName=" + userName + ", gameRoomName=" + gameRoomName + ", from=" + from
