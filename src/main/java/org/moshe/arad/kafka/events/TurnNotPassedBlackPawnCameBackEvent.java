...
@Component
@Scope("prototype")
public class TurnNotPassedBlackPawnCameBackEvent extends BackgammonEvent{
	...
	public TurnNotPassedBlackPawnCameBackEvent() {
	
	}

	public TurnNotPassedBlackPawnCameBackEvent(String userName, String gameRoomName, int from, int to, BackgammonBoard board,
	...
	public String toString() {
		return "TurnNotPassedBlackPawnCameBackEvent [userName=" + userName + ", gameRoomName=" + gameRoomName
