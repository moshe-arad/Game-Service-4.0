...
@Component
@Scope("prototype")
public class TurnNotPassedWhitePawnTakenOutEvent extends BackgammonEvent{
	...
	public TurnNotPassedWhitePawnTakenOutEvent() {
	
	}

	public TurnNotPassedWhitePawnTakenOutEvent(String userName, String gameRoomName, int from, int to, BackgammonBoard board,
	...
	public String toString() {
		return "LastMoveWhitePawnTakenOutEvent [userName=" + userName + ", gameRoomName=" + gameRoomName + ", from="
				+ from + ", to=" + to + ", board=" + board + ", firstDice=" + firstDice + ", secondDice=" + secondDice
				+ ", isWhite=" + isWhite + "]";
	}
