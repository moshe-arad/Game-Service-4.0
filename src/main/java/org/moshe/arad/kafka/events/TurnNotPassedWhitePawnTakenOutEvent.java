...
public class TurnNotPassedWhitePawnTakenOutEvent extends BackgammonEvent{
	...
	public TurnNotPassedWhitePawnTakenOutEvent(String userName, String gameRoomName, int from, int to,
	...
	public String toString() {
		return "TurnNotPassedWhitePawnTakenOutEvent [userName=" + userName + ", gameRoomName=" + gameRoomName
