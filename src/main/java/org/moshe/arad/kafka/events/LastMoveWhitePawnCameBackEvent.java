...
@Component
@Scope("prototype")
public class LastMoveWhitePawnCameBackEvent extends BackgammonEvent{
	...
	public LastMoveWhitePawnCameBackEvent() {
	
	}

	public LastMoveWhitePawnCameBackEvent(String userName, String gameRoomName, int from, int to, BackgammonBoard board,
	...
	public String toString() {
		return "UserMadeInvalidMoveEvent [userName=" + userName + ", gameRoomName=" + gameRoomName + ", from=" + from
				+ ", to=" + to + ", board=" + board + ", firstDice=" + firstDice + ", secondDice=" + secondDice
				+ ", isWhite=" + isWhite + "]";
	}
