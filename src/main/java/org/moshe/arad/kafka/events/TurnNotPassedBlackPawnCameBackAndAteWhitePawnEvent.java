...
@Component
@Scope("prototype")
public class TurnNotPassedBlackPawnCameBackAndAteWhitePawnEvent extends BackgammonEvent{
	...
	public TurnNotPassedBlackPawnCameBackAndAteWhitePawnEvent() {
	
	}

	public TurnNotPassedBlackPawnCameBackAndAteWhitePawnEvent(String userName, String gameRoomName, int from, int to,
	...
	public String toString() {
		return "TurnNotPassedBlackPawnCameBackAndAteWhitePawnEvent [userName=" + userName + ", gameRoomName="
