...
@Component
@Scope("prototype")
public class LastMoveBlackPawnTakenOutEvent extends BackgammonEvent{
	...
	public LastMoveBlackPawnTakenOutEvent() {
	
	}

	public LastMoveBlackPawnTakenOutEvent(String userName, String gameRoomName, int from, int to, BackgammonBoard board,
	...
	public String toString() {
		return "LastMoveBlackPawnTakenOutEvent [userName=" + userName + ", gameRoomName=" + gameRoomName + ", from="
