...
@Component
@Scope("prototype")
public class LastMoveWhiteAteBlackPawnEvent extends BackgammonEvent{
	...
	public LastMoveWhiteAteBlackPawnEvent() {
	
	}

	public LastMoveWhiteAteBlackPawnEvent(String userName, String gameRoomName, int from, int to, BackgammonBoard board,
	...
	public String toString() {
		return "LastMoveWhiteAteBlackPawnEvent [userName=" + userName + ", gameRoomName=" + gameRoomName + ", from="
